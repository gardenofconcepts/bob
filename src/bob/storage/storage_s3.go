...
func (svc *StorageS3Backend) Has(build StorageRequest) bool {
...
func (svc *StorageS3Backend) Get(build StorageRequest) {
...
func (svc *StorageS3Backend) Put(build StorageRequest) {
